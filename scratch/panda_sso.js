...
(function() {
    ...
    function renderUserUI(data) {
        ...
        if (usernameEl) {
            usernameEl.innerHTML = `<span class="user-nickname-text" style="display:inline-block;max-width:120px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;vertical-align:middle;">${userNickname}</span> <span style="margin-left: 8px; color: #ffb700; font-weight: bold; white-space: nowrap; display:inline-flex; align-items:center;"><img src="/scratch/projects/editor/https://pandapanda6666.github.io/shop/coin.svg" style="width:16px;height:16px;margin-right:2px;" onerror="this.style.display='none'" />${balance}</span>`;
        }
        if (avatarEl) {
