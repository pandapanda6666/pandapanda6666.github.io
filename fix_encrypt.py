...
# Restore original
target1 = '''window.encryptSb3 = async function(originalBlob) {
...
replace1 = "const newBlob = await newZip.generateAsync({"

if target1 in content:
    content = content.replace(target1, replace1)

# Now inject it globally at the top
target2 = 'console.log("PandaGuard: Initializing universal download interceptor with Blob caching...");'
replace2 = '''console.log("PandaGuard: Initializing universal download interceptor with Blob caching...");
