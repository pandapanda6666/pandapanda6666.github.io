...
bad_end = html.find('return assContent;\n        };', bad_start) + 31
...
good_func = '''window.generateASS = function() {
            ...
            let assContent = `[Script Info]\\nScriptType: v4.00+\\nPlayResX: 1920\\nPlayResY: 1080\\nWrapStyle: 0\\n\\n[V4+ Styles]\\nFormat: Name, Fontname, Fontsize, PrimaryColour, SecondaryColour, OutlineColour, BackColour, Bold, Italic, Underline, StrikeOut, ScaleX, ScaleY, Spacing, Angle, BorderStyle, Outline, Shadow, Alignment, MarginL, MarginR, MarginV, Encoding\\nStyle: Default,${fontName},32,&H00FFFFFF,&H000000FF,&H00000000,&H80000000,-1,0,0,0,100,100,0,0,3,2,0,2,10,10,10,1\\n\\n[Events]\\nFormat: Layer, Start, End, Style, Name, MarginL, MarginR, MarginV, Effect, Text\\n`;
            ...
            currentSubs.forEach(sub => {
                ...
                for (let i = outlines.length - 1; i >= 0; i--) {
                    ...
                    if (currentWidth > 0) {
                        ...
                        let tags = `{\\\\pos(${x},${y})\\\\fs${fs}\\\\fn${fn}\\\\1c${oc}\\\\3c${oc}\\\\4c${bc}\\\\b${bold}\\\\bord${currentWidth}\\\\BorderStyle3}`;
                        assContent += `Dialogue: 0,${start},${end},Default,,0,0,0,,${tags}${text}\\n`;
                    }
                    currentWidth -= parseInt(ol.width || 0);
                }
                
                let mainTags = `{\\\\pos(${x},${y})\\\\fs${fs}\\\\fn${fn}\\\\1c${c1}\\\\3c${c1}\\\\4c${bc}\\\\b${bold}\\\\bord0\\\\BorderStyle3}`;
